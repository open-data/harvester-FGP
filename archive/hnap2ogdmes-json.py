...
def main():
    ...
    for record in records:
        ...
        if sanitySingle('NOID,' + OGDMES_property, tmp) is False:
        ...
        ##################################################
        if HNAP_primary_language is False or OGDMES_fileIdentifier is False:
            break
        ...
        if sanityMandatory(
                ...
                OGDMES_property +
                '-OrganizationName-' +
                CKAN_primary_lang, tmp):
            if sanitySingle(
                    OGDMES_fileIdentifier + ',' +
                    OGDMES_property + CKAN_primary_lang,
                    tmp):
...
#        tmp = fetchXMLValues(record,"gmd:contact/" +
#            "gmd:CI_ResponsibleParty/" +
#            "gmd:contactInfo/" +
#            "gmd:CI_Contact/" +
#            "gmd:phone/" +
...
#        if sanityMandatory(OGDMES_fileIdentifier+','+
#            OGDMES_property+'-Voice-'+CKAN_primary_lang,tmp):
#                primary_vals.append(sanityFirst(tmp))
#        tmp = fetchXMLValues(record,"gmd:contact/" +
#            "gmd:CI_ResponsibleParty/" +
#            "gmd:contactInfo/" +
...
#        if sanityMandatory(OGDMES_fileIdentifier+','+
#            OGDMES_property+'-Voice-'+CKAN_secondary_lang,tmp):
#                second_vals.append(sanityFirst(tmp))
        ...
        if sanityMandatory(OGDMES_fileIdentifier + ',' + OGDMES_property, tmp):
            if sanitySingle(
                ...
                if sanityDate(
                    ...
                    debug_output[
                        '08-OGDMES metadataRecordDateStamp'] = date_str
        ...
        # r = record.xpath("gmd:identificationInfo/" +
        #    "gmd:MD_DataIdentification/" +
        #    "gmd:citation/" +
        #    "gmd:CI_Citation/" +
        #    "gmd:date/" +
        #    "gmd:CI_Date", namespaces={
        #       'gmd':'http://www.isotc211.org/2005/gmd',
        #       'gco':'http://www.isotc211.org/2005/gco'})
        r = record.xpath(
            "gmd:identificationInfo/" +
        ...
        if sanityMandatory(
            ...
            if sanitySingle(
                ...
                if values[0] != 'Government of Canada' and values[
                        0] != 'Gouvernement du Canada':
                    reportError(
                        OGDMES_fileIdentifier +
                        ',' +
                        organisationName +
                ...
                for GOC_Div in values:
                    ...
                    if termsValue:
                        if CKAN_primary_lang == 'en':
                            # Use CL value, cleaner and more consistent
                            primary_vals.append(termsValue[0])
                        else:
                            # Use CL value, cleaner and more consistent
                            primary_vals.append(termsValue[2])
        ...
        if sanitySingle(OGDMES_fileIdentifier + ',' + OGDMES_property, tmp):
            ...
            debug_output[
                '19-OGDMES positionName' +
                OGDMES_primary_lang] = '[NOT SUPPLIED]'
        ...
        if sanitySingle(OGDMES_fileIdentifier + ',' + OGDMES_property, tmp):
            ...
            debug_output[
                '19-OGDMES positionName' +
                OGDMES_secondary_lang] = '[NOT SUPPLIED]'
        ...
        if not len(primary_vals):
            reportError(
                OGDMES_fileIdentifier +
                ',' +
                'contactInfo,madatory field missing,""')
        ...
        debug_output['20-OGDMES contactInfo' +
                     OGDMES_primary_lang] = ','.join(primary_vals)
        debug_output['20-OGDMES contactInfo' +
                     OGDMES_secondary_lang] = ','.join(second_vals)
        ...
        debug_output['23-OGDMES descriptiveKeywords' +
                     OGDMES_primary_lang] = ','.join(primary_vals)
        debug_output['23-OGDMES descriptiveKeywords' +
                     OGDMES_secondary_lang] = ','.join(second_vals)
        ...
        if sanityMandatory(OGDMES_fileIdentifier + ',' + OGDMES_property, tmp):
            if sanitySingle(
                ...
                if sanityMandatory(
                    ...
                    debug_output[
                        '24-OGDMES status'] = json_record[OGDMES_property]
        ...
        debug_output[
            '25-OGDMES associationType'] = json_record['association_type']

        # OGDMES-26 aggregateDataSetIdentifier
        ##################################################
        # No test data but this XPATH bas been confirmed by Marie-Eve Martin @
        # NRCan
        ...
        if sanityMandatory(OGDMES_fileIdentifier + ',' + OGDMES_property, tmp):
            ...
            # After we check aganst the CL we need to make sure thre still is
            # data before you accept it
            if sanityMandatory(
                    OGDMES_fileIdentifier +
                    ',' +
                    OGDMES_property,
                ...
                debug_output[
                    '28-OGDMES topicCategory'] = ','.join(topicCategory_array)
        ...
        if sanityMandatory(OGDMES_fileIdentifier + ',' + OGDMES_property, tmp):
            if sanitySingle(
                ...
                debug_output[
                    '29-OGDMES westBoundingLongitude'] = sanityFirst(tmp)
        ...
        if sanityMandatory(OGDMES_fileIdentifier + ',' + OGDMES_property, tmp):
            if sanitySingle(
                ...
                json_record[OGDMES_property] = sanityFirst(tmp)
                debug_output[
                    '30-OGDMES eastBoundingLongitude'] = sanityFirst(tmp)
        ...
        if sanityMandatory(OGDMES_fileIdentifier + ',' + OGDMES_property, tmp):
            if sanitySingle(
                ...
                json_record[OGDMES_property] = sanityFirst(tmp)
                debug_output[
                    '31-OGDMES southBoundingLongitude'] = sanityFirst(tmp)
        ...
        if sanityMandatory(OGDMES_fileIdentifier + ',' + OGDMES_property, tmp):
            if sanitySingle(
                ...
                json_record[OGDMES_property] = sanityFirst(tmp)
                debug_output[
                    '32-OGDMES northBoundingLongitude'] = sanityFirst(tmp)

        GeoJSON = {}
        GeoJSON['type'] = "Polygon"
        GeoJSON['coordinates'] = [[
            [float(json_record['westBoundingLongitude']),
             float(json_record['southBoundingLongitude'])],
            [float(json_record['eastBoundingLongitude']),
             float(json_record['southBoundingLongitude'])],
            [float(json_record['eastBoundingLongitude']),
             float(json_record['northBoundingLongitude'])],
            [float(json_record['westBoundingLongitude']),
             float(json_record['northBoundingLongitude'])],
            [float(json_record['westBoundingLongitude']),
             float(json_record['southBoundingLongitude'])]
        ...
        # json_record['southBoundingLongitude']
        ...
        tmp = fetchXMLValues(
            ...
            "gml:beginPosition")
        # if
        # sanityMandatory(OGDMES_fileIdentifier+','+OGDMES_property+'Start',tmp):
        if sanitySingle(
                OGDMES_fileIdentifier +
                ',' +
                OGDMES_property +
            ...
            if sanityDate(
                ...
                maskDate(
                    sanityFirst(tmp))):
                json_record['time_period_coverage_start'] = maskDate(
                    sanityFirst(tmp))
                temporalElement_array.append(
                    json_record['time_period_coverage_start'])
        ...
        if check_for_blank == '9999-09-09' or sanityDate(
                OGDMES_fileIdentifier + ',' + OGDMES_property + 'End',
                maskDate(check_for_blank)):
            json_record['time_period_coverage_end'] = maskDate(check_for_blank)
            temporalElement_array.append(
                json_record['time_period_coverage_end'])
        # End ADAPTATION #2 & #3

        debug_output[
            '33-OGDMES temporalElement'] = ','.join(temporalElement_array)
        ...
        if sanityMandatory(OGDMES_fileIdentifier + ',' + OGDMES_property, tmp):
            if sanitySingle(
                ...
                # Can you find the CL entry?
                termsValue = fetchCLValue(
                    tmp[0], napMD_MaintenanceFrequencyCode)
                if not termsValue:
                    termsValue = []
                if sanityMandatory(
                        OGDMES_fileIdentifier +
        ...
        # Ian Ward @ CKAN:disable:json_record['type'] = 'Open Maps / Cartes
        # ouvert'
        ...
        for resource in record_resources:
            ...
            if sanityMandatory(
                ...
                if sanitySingle(
                    ...
                    debug_output[
                        ...
                        str(resource_no) +
                        '] ResourceName' +
                        OGDMES_primary_lang] = sanityFirst(tmp)
            ...
            if sanityMandatory(
                ...
                if sanitySingle(
                    ...
                    debug_output[
                        ...
                        str(resource_no) +
                        '] ResourceName' +
                        OGDMES_secondary_lang] = sanityFirst(tmp)
            ...
            if sanityMandatory(
                ...
                # does not track resource content type, format or language.
                ...
                if description_text.count(';') != 2:
                    ...
                    json_record_resource[
                        'contentType'] = res_contentType.strip()
                    debug_output[
                        '41-OGDMES Resource[' +
                        str(resource_no) +
                        '] format'] = res_format.strip()
                    debug_output[
                        '42-OGDMES Resource[' +
                        str(resource_no) +
...
# #### Controlled Lists
# Readability and thus maintainability of these controlled lists is best served
# outside PEP8.  The client can read these structures as is.
OGDMES2ID                       = {
    'fileIdentifier'                : '01',
    'shortKey'                      : '02',
